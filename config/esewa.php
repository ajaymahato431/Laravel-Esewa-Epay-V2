...
return [
    ...
    'success_url'  => env('ESEWA_SUCCESS_URL', 'https://your-app.com/esewa/success'), // final redirect after verification
    'failure_url'  => env('ESEWA_FAILURE_URL', 'https://your-app.com/esewa/failure'), // final redirect when payment fails
